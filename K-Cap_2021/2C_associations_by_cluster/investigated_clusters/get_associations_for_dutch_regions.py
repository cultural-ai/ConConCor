...
def main():
    ...
    # ------
    sav_suffix = "dutch_regions_16_341903"

    # Note: stripped of 'dorp'
    clusters_of_interest = {'dutch_regions_16_341903':(14, set(["veere", "gouda", "haarlem", "edam", "oostburg", "utrecht", "purmerend", "dordrecht", "delft", "alkmaar", "veenendaal", "wassenaar", "waterland", "noordhollandsch", "overschie", "zeel", "schag", "medemblik", "alme", "hoorn", "woerden", "hilversum", "zaandam", "watergraafsmeer", "goes", "voorburg", "beverwijk", "schiedam", "amersfoort", "nieuwkoop", "terschelling", "middelburg", "voorschoten", "naarden", "krimpen", "huizen", "oegstgeest", "ede", "lelden", "tielerwaard", "schoonhoven", "zaan", "kralingen", "zuidland", "ameland", "capelle", "muiden", "bunschoten", "velsen", "aalsmeer", "beemster", "noordwijk", "monnikendam"]))} 
