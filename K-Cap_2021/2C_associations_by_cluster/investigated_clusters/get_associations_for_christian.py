...
def main():
    ...
    # ------
    sav_suffix = "christianity_14_341924"

    # Note: stripped of 'dorp'
    clusters_of_interest = {'christianity_14_341924':(14, set(["zouaven", "vrouwekerk", "bedevaart", "kapel", "wijdingen", "statie", "sabbath", "beleggen", "samenkomst", "lezing", "deelnemen", "bestuursvergadering", "bijwonen", "seizoen", "bisdom", "inwijding", "bijeenkomst", "vergadering", "oudejaarsavond", "doorloopen", "commissievergadering", "plechtigheid", "kroningsfeest", "optocht", "slotvergadering", "samenkomen", "feest", "vergadering-", "deelneming", "mis", "pasch", "viering", "vergaderen", "genodigde", "hoofdbestuursvergadering", "liefdezuster", "plechtig", "jubileum", "kruisweg", "volksvermaak", "pelgrimstocht", "dering", "apostolaat", "spreekbeurt", "soos", "broederschap", "intentie", "kathedraal", "eucharistisch", "pelgrim", "niklaas", "ochtendgebed", "godsdienstoefening", "parade",  "bijeen", "jaarbeurs", "avondfeest", "lof", "vastenavond", "rustdag", "voltallig", "organiseeren", "toegewijd", "deelname", "feestelijkheid", "communie", "bijwoning", "bijeenkomen", "parochie", "feestviering", "sixtijnsch", "volksfeest", "jaarvergadering", "ommegang", "jubilee", "paschen", "missieweek", "maskerade", "pinksterdagen", "reunist", "openingsuur", "jeugddag", "congreszitting", "basiliek", "feesten", "nicolaasfeest", "middaggebed", "vacantiemaand", "kermis", "parochiaan"]))} 
