...
def main():
    ...
    # ------
    sav_suffix = "money_14_342081"
    clusters_of_interest = {'money_14_342081':(14, set(["provisie", "belasting", "kas", "opbrengst", "accijns", "voorschot", "domein", "opbrengen", "uitvoerrecht", "bedrag", "kohier", "dagelijksch", "som", "schuldbekentenis", "receten", "premie", "uitbetalen", "tekort", "rouwgeld", "invoerrecht", "reserveren", "opcenten", "bouwkosten", "reserveeren", "successie", "aanlegkosten", "inkomst", "papierengeld", "inventaris", "crediet", "jaarlijkschc", "werkkapitaal", "liquidatie", "entree", "sommen", "omslag", "belastingen", "ontvang", "onderpand", "achterstallig", "loodsgeld", "houder", "inleg", "registratie", "uitkeren", "ponds", "crediteur"
