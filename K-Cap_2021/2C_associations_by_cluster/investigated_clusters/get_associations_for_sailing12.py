...
def main():
    ...
    # ------
    sav_suffix = "sailing_12_341175"

    # Note: stripped of 'dorp'
    clusters_of_interest = {'sailing_12_341175':(12, set(["schipper", "visscher", "sleepboot", "opvarende", "matroos", "wal", "kano", "bemannen", "aanbrachten", "stoomboo", "vaartuig", "kaper", "zeeman", "dok", "booi", "motorboot", "schuit", "bevaart", "loodsschoener", "texelsch", "sloep", "schepeling", "roeiboot" ]))} 
