...
def main():
    ...
    # ------
    sav_suffix = "emotions_14_341764"
    clusters_of_interest = {'emotions_14_341764':(8, set(["bozen", "scherts", "knipoog", "verlegen", "lief", "bid", "wrevelig", "vergiffenis", "argeloos", "ongemakkelijk", "fronsen", "zuchten", "gewaardigen", "knorrig", "opluchten", "vervelen", "fluisteren", "brommen", "vleien", "onwillekeurig", "klagend", "keuvelen", "parmantig", "vergenoegen", "grinniken", "struikroover", "henl", "minzaam", "afluisteren", "fideel", "bedeesd", "kindsch", "eigenwij", "verwaardigen", "verstoppertje", "verbouwereerd", "bijdehand", "neerbuigend", "aanhalig", "werktuigelijk", "tusschenbeien", "schuchter", "babbel", "galant", "flappen", "hoofdschudden", "vriendelijk" 
        ]))} 
