...
def main():
    ...
    # ------
    sav_suffix = "behaviours_and_states_of_being_14_341670"
    clusters_of_interest = {'behaviours_and_states_of_being_14_341670':(8, set(["onverschillig", "verdrukking", "opkomen", "leugenachtig", "verrader", "gewillig", "bres", "omgaan", "voorvechter", "waard", "beleedigt", "lankmoedig", "machtig", "beetje", "eerlijk", "zelfverheerlijking", "verwijten", "belooven", "verwerven", "bekennen", "berispen", "juk", "anti-semitisme", "ontstemmen", "godsdien", "verdrukken", "hooghartig", "creatuur", "dwaasheid", "wreedheid", "loyauteit", "groot-nederlandsch", "onverdraagzaam", "ergens", "gehoorzamen", "despoot", "toornen", "vaderlandslievende", "belasteren", "jegens", "beschimping", "redeneer", "kortzichtig", "onbescheidenheid", "vergoelijken", "gehoorzaamheid", "volks", "verdraaien", "ongeloovig", "wereldgeschiedenis", "niert", "geweldenarij", "recalcitrant", "geduldig", "catholicisme", "verontschuldiging", "vastbeslotenheid", "nmar", "verleid", "onbeschroomd", "onkiesch", "uitlekken", "dwaas", "stoutweg", "kieskeurig", "onzinnig", "verstandig", "strijder", "ophitsen", "wraakgierig", "overweldigen", "verdraagzaam", "overweldig", "machtswellust", "overheerscher", "logika", "beseff", "uitvlucht", "ignobel", "isme", "gewaagd", "hervormer", "onbehoorlijk", "geweten", "inpalmen", "theoreticus", "kinderachtig", "wordenl", "beschamen", "drogreden", "lasteraar", "lastering", "voorwendsel", "bezondigen", "afrekenen", "dweper", "inscherpen", "verongelijkte", "veront", "proefkonijn", "calvinistisch", "leugen", "waardering", "betitelen", "barbarisme", "bedriegen", "belachelijk", "hatelijkheid", "strijdlustig", "spijt", "onverdraagzaamheid", "list", "gruwel", "schyn", "ijveraar", "naar", "luchthartig", "kuituur", "duisterling", "uitdagen", "onderworpenheid", "blijk", "bespottelijk", "strijdvaardig", "onbeschaamd", "staatsleer", "weerstaan", "tolerantie", "antipathiek", "vrijmetselarij", "verzinnen", "were'd", "welgezind", "mohammedanisme", "zovele", "broederlijk", "gehate", "cynisch", "onwillig", "patriotisch", "uittarten", "verloochenen", "demagogisch", "gemeene", "afrikaans", "chauvinisme", "afzweren", "heeleinaal", "individualisme", "slavenjuk", "waagstuk", "medestrijder", "bemoeizucht", "lijfeigenschap", "blameren", "studentenwereld", "dwaze", "minacht", "geringschatten", "onbekeerd", "schijnt", "inblazing", "waarachtig", "verloochening", "terwille", "revolutiejaar", "hatelijk", "kaste", "vrijmetselaar", "egoist", "proseliet", "gedragen", "wereldtooneel", "dweeper", "overwint"]))} 
