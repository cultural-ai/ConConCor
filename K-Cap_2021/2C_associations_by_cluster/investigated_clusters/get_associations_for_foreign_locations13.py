...
def main():
    ...
    # ------
    sav_suffix = "foreign_locations_342079"

    # even more significant with removal of suriname
    clusters_of_interest = {'foreign_locations_342079':(13, set(["suriname", "curacao", "bovenwindsch", "middellandsche", "zee", "kust", "dardanellen", "oceaan", "bahrein", "inschepen", "bonaire", "djeddah", "paramaribo", "san", "guaira", "haven", "kaapstad", "cayenne", "curasao", "santiago", "hupeh", "san-", "francisco", "senegal", "eustatius", "curagao", "noordzee", "karachi", "singapore", "baai", "aruba", "atbara", "saigon", "lapan", "albina", "zuidkust", "osaka", "reiger", "hongkong", "benin", "atlantischen", "bestemming", "wereldzee", "marmora", "arriveren", "herat", "havana", "dardanell", "zuidwestkust", "arabic", "haiti", "honkong", "scheepsgelegenheid", "simla", "bengalen", "delhi", "suez-kanaal", "haifa"]))} 
