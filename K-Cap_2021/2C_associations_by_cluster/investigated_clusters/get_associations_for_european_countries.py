...
def main():
    ...
    # ------
    sav_suffix = "european_countries_340893"

    # Note: stripped of 'dorp'
    clusters_of_interest = {'european_countries_340893':(12, set(["engeland", "frankrijk", "duitschiand", "zwitserland", "turkije", "frankrgk", "zweden", "ruslaud", "oostenrijk", "duitschland", "lauden", "groot-", "frankryk", "denemarken", "hongarije", "duitsland", "kusland", "tenrijk", "dultschland", "continentaal", "duitechland", "duiischland", "duitsehland", "tsjecho-slowakije", "duitscbland", "noorwegen", "erankrijk"]))} 
    ...
    for cluster_label, extract_ids in extracts_by_cluster.items():
        ...
        stats["proprotion_with_contentious"].append((count_c) / (count))
